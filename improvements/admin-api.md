...
> | `notify` | 과제 9 (알림) | POST /notify/send, GET /notify/stream (SSE) | [design/notify-service.md](../design/notify-service.md) |
> | `regulation` | 과제 6 (규정 관리) | POST /regulations/upload | [challenges/06](../challenges/06-knowledge-base.md) |
> | `compliance` | 과제 5 (문서 적합성) | POST /compliance/check | [design/doc-compliance.md](../design/doc-compliance.md) |
>
