...
| # | 결정 | 영향 | 대안 | 상세 |
|:-:|-----|------|-----|:----:|
| 🔴 **P0-1** | 그룹웨어 **Write 권한** 확보 | 과제 2 **전체 불가** (쓰기 연산 필수 3 MCP 도구) | Read-Only 탐지만 (60% 기능) | [보기](decisions.md#-d2-06-미확정-시-영향--과제-2-전체-불가-사유) |
| 🔴 **P0-2** | 규정 문서 **10종** 제공 | POC 2 **전체 지연** (과제 4/5/6 의존) | 공개 법령 대체 / 분할 수집 | [보기](decisions.md#-d6-02-미확정-시-영향--poc-2-전체-지연-사유) |
| 🔴 **P0-3** | **노조 협의** 진행 | 과제 8 **법적 리스크** (시스템 중단·과태료) | 2단계 연기 / 익명화 | [보기](decisions.md#-d8-05-미진행-시-영향--과제-8-2단계-연기-필수-사유) |
...
| 감사 샘플 부족 | 과제 7·8 품질 저하 | ../04-prerequisites.md 합성 데이터 |
...
- [../challenges/00-index.md](../challenges/00-index.md) — 전체 마스터
- [../01-architecture.md](../01-architecture.md) — 갭 분석
- [../01-architecture.md](../01-architecture.md) — 최적 아키텍처
- [../02-project-plan.md](../02-project-plan.md) — 시나리오별 제안
- [customer/meeting-guide.md](meeting-guide.md) — 고객 미팅 원본 의제
- [04-prerequisites.md](../04-prerequisites.md) — 외부 시스템 사전 요건
