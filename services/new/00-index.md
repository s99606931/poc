...
> **기준일**: 2026-04-22
> **대상**: POC 신규 서비스 2종 + 기존 서비스 확장 2종 (원안의 notify-service·doc-compliance 통합 대안)
> **기준 문서**: [../../01-architecture.md](../../01-architecture.md)
...
**P0 3대 결정 참조**: [decisions.md](../../challenges/decisions.md#-p0-최우선-3대-결정--불가지연-통합-요약)
...
- [../../challenges/00-index.md](../../challenges/00-index.md) — POC 마스터
- [../../01-architecture.md](../../01-architecture.md) — 전체 아키텍처
- [../../01-architecture.md](../../01-architecture.md) — POC 전체 아키텍처
